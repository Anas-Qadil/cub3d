...
/*   Updated: 2022/06/03 15:57:18 by aqadil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    read_north_texture(t_data *mlx)
{
    ...
    mlx->t_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/stone1.xpm", &mlx->t_w, &mlx->t_h);
...
void    read_west_texture(t_data *mlx)
{
	...
	i = 0;
	k = 0;
    mlx->tw_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/stone2.xpm", &mlx->tw_w, &mlx->tw_h);
...
void    read_east_texture(t_data *mlx)
{
    ...
    mlx->te_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/stone3.xpm", &mlx->te_w, &mlx->te_h);
...
void    read_south_texture(t_data *mlx)
{
	...
	mlx->ts_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/stone4.xpm", &mlx->ts_w, &mlx->ts_h);
