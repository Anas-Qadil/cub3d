...
/*   Updated: 2022/06/06 09:13:43 by aqadil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    read_north_texture(t_data *mlx)
{
    ...
    mlx->t_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/redbrick.xpm", &mlx->t_w, &mlx->t_h);
...
void    read_west_texture(t_data *mlx)
{
	...
	i = 0;
	k = 0;
    mlx->tw_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/skull.xpm", &mlx->tw_w, &mlx->tw_h);
...
void    read_east_texture(t_data *mlx)
{
    ...
    mlx->te_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/bluestone.xpm", &mlx->te_w, &mlx->te_h);
...
void    read_south_texture(t_data *mlx)
{
	...
	mlx->ts_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/pumking.xpm", &mlx->ts_w, &mlx->ts_h);
...
void    read_door_texture(t_data *mlx)
{
	...
	mlx->door_img = mlx_xpm_file_to_image(mlx->mlx, "./textures/door.xpm", &mlx->door_w, &mlx->door_h);
